    ...
    connect(callback) {
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            (0, standard_as_callback_1.default)(this.connector.connect(function (type, err) {
                ...
                if (err) {
                    debug("got an error, flushQueue and reject", err.message, _this._getDescription());
                ...
                if (stream.connecting) {
                    ...
                    if (options.connectTimeout) {
                        debug("setting stream.timeout to connectTimeout", options.connectTimeout);
                        /*
                        ...
                        stream.once(CONNECT_EVENT, function () {
                            debug("setting connectTimeoutCleared", true, "and socket.setTimeout(0)");
